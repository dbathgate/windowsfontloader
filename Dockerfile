...
RUN powershell.exe -command reg.exe export 'HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Fonts' C:\Fonts\fonts.reg
RUN powershell.exe -command reg.exe export 'HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\FontMapper\FamilyDefaults' C:\Fonts\font_defaults.reg
RUN powershell.exe -command reg.exe export 'HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\FontLink\SystemLink' C:\Fonts\font_link.reg
